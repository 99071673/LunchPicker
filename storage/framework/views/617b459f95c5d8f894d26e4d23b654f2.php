...
<body class="min-h-screen m-0 font-sans bg-gray-300 flex flex-col">
    ...
    <header class="bg-[#00333f] text-white p-5 grid grid-cols-3 items-center">
        ...
        <div class="font-bold text-4xl text-center"><?php echo $__env->yieldContent('pagetitle'); ?></div>
...
<?php /**PATH C:\Users\YukiT\OneDrive - Da Vinci College\FASE 3\Lunch Picker App\LunchPicker\resources\views\layouts\master.blade.php ENDPATH**/ ?>